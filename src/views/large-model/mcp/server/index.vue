<template>
  <div class="container-list">
    ...
    >
      ...
      <tiny-grid-column field="transportProtocol" :title="$t('llm.mcp-server.transportProtocol')" align="center" width="120"/>
      ...
      >
        <template #default="scope">
          <tiny-action-menu
            :max-show-num="3" :spacing="8" :options="proxy.$hasPermission(optionsBtnFilter(scope.row))"
