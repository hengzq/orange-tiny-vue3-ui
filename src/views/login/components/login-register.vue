    ...
    >
      ...
      >
        <tiny-input
          ...
          :placeholder="$t('login.register.form.username.placeholder')"
        ></tiny-input>
      </tiny-form-item>
      <tiny-form-item
        :label="$t('login.register.form.password')"
        prop="password"
        size="medium"
      >
        <tiny-input
      ...
      <tiny-form-item
        :label="$t('login.register.form.confirmPassword')"
        prop="confirmPassword"
        size="medium"
      >
        <tiny-input
          v-model="createData.confirmPassword"
          :placeholder="$t('login.register.form.confirmPassword.placeholder')"
          type="password"
          show-password
        ></tiny-input>
      </tiny-form-item>
