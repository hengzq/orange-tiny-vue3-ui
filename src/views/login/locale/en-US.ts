export default {
  ...
  'login.form.userName.placeholder': 'Username:orange',
  'login.form.password.placeholder': 'Password:hengzq.cn',
  ...
  'login.form.confirmPassword.placeholder': 'Confirm Password：',
  ...
  'login.register.form.username': 'Account:',
  'login.register.form.username.placeholder': 'Enter login account',
  'login.register.form.password': 'Password:',
  'login.register.form.password.placeholder': 'Registration password：',
  'login.register.form.confirmPassword': 'Confirm Password:',
  'login.register.form.confirmPassword.placeholder': 'Confirm Password：',
