export default {
  ...
  'login.form.confirmPassword.placeholder': '确认密码：',
  ...
  'login.register.form.username.placeholder': '请输入登录账号',
  'login.register.form.password': '密码',
  'login.register.form.password.placeholder': '请输入密码',
  'login.register.form.confirmPassword': '确认密码',
  'login.register.form.confirmPassword.placeholder': '请输入确认密码',
